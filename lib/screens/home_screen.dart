                    ...
                    return SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (context, i) {
                          ...
                          final ratingSum = (data['ratingSum'] ?? 0) as int;
                          final ratingCount = (data['ratingCount'] ?? 0) as int;
                          final average = ratingCount == 0 ? 0.0 : ratingSum / ratingCount;
                          return Padding(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.description, color: AppTheme.info, size: 18),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                StarRating(
                  ...
                  count: count,
                  onRate: (rating) async {
                    await _firebaseService.rateNote(
                      noteId: noteId,
                      userId: _currentUserId,
                      rating: rating,
                    );
          ...
          IconButton(
            ...
            onPressed: () => _showFlagDialog(noteId),
            tooltip: 'Flag this note',
          ),
        ],
      ),
    );
  ...
  void _showFlagDialog(String noteId) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Flag this note'),
        content: TextField(
          controller: reasonController,
          decoration: const InputDecoration(hintText: 'Why are you flagging this?'),
          maxLines: 2,
        ),
        actions: [
          TextButton(
