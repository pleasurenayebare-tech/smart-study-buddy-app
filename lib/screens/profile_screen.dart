                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            _buildInfoRow(Icons.person_outline, 'Full Name', _profile?['fullName'] ?? '-', AppTheme.primary),
                            _buildDivider(),
                            _buildInfoRow(Icons.alternate_email, 'Username', '@${_profile?['username'] ?? '-'}', AppTheme.info),
                            _buildDivider(),
                            _buildInfoRow(Icons.email_outlined, 'Email', _profile?['email'] ?? '-', AppTheme.warning),
                            _buildDivider(),
                            _buildInfoRow(Icons.school_outlined, 'Course', _profile?['course'] ?? 'Not set', AppTheme.primary),
                            _buildDivider(),
                            _buildInfoRow(Icons.info_outline, 'Bio', _profile?['bio'] ?? 'No bio added yet', AppTheme.success),
                          ],
                        ),
                      ),
                    ),
